...
We stand in solidarity with our colleagues who are being targeted, and are asking you to show your public support. Join us in calling on CEO Meredith Levine to stop union busting and recognize our union.
...
<p>Without a union or a contract, our employer can unilaterally change our working conditions or fire us at any time, without cause. Our employer also has no legal obligation to respond to at-will employees’ feedback and concerns.</p>
  ...
  <FAQItem question="What is the American Arbitration Association (AAA)?">
    <p>The American Arbitration Association (AAA) is a private not-for-profit that offers a variety of administrative and election services as a neutral third party. They facilitate online elections for existing unions, as well as elections to form new unions. They have even recently certified several union elections in our local chapter of the NewsGuild.</p>
  </FAQItem>
  <FAQItem question="Why does the Tech Union prefer an AAA election?">
    <p>The AAA election is easier for voters: the online format is more straightforward and user-friendly than the NLRB’s mail-in ballots, especially for members who have relocated during the pandemic. In addition, the process is a lot faster, due to the online format of the election and the speed with which the AAA is able to initiate the voting process. The faster we are able to vote, the sooner we will gain the benefits and protections of a formal union, like shop stewards, status quo protections, and the ability to request information from our employer.</p>
    <p>Note: Elections certified by the AAA are legally binding, just like NLRB elections!</p>
  </FAQItem>
