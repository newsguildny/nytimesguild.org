...
<FullBleedImage alt="An image of a set table with a roast turkey and side dishes, with the words Happy Strikesgiving superimposed." src="/images/the-table/tabletop5.webp" />
...
<FullBleedImage alt="Lightning striking a wirecutter tool, reading 'Wirecutter on strike!'" src="/images/the-table/11-29-wc-strike-flier.webp" />
