...
subheading: Meet The New York Times Tech Guild.
---
## Who We Are
...
### We make the NYT's most profitable products.
We're fighting for a contract that establishes the equitable working conditions and protections we deserve.



<iframe width="560" height="315" src="https://www.youtube.com/embed/i9MZoTi1xpI?si=tBs_MuGdOTbwQY4t" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

## What We're Fighting For

We unionized because our members want a collective voice in making the New York Times a great place to work in tech. We care deeply about the work we do here and even more so about the welfare of our colleagues. 
...
<figure>
	<img className="regular-width" alt="photo collage of New York Times Tech Guild members on a walkout outside the New York Times building" src="/images/walkout-clear.jpg" />
	<figcaption>photo by Sean G. Mackell | NYC CLC</figcaption>
</figure>
...
$400 M authorized for stock buybacks but no contract to invest in the workers that have generated those profits? 
